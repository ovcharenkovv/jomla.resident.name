...
class PhocaGalleryCpControllerPhocaGalleryu extends PhocaGalleryCpController
{
	...
	function createfolder() {
		...
		switch ($viewBack) {
			case 'phocagalleryi':
				$link = 'index.php?option=com_phocagallery&view=phocagalleryi&tmpl=component&folder='.$parent.'&tab='.(int)$tab.'&field='.$field;
			break;
		
			case 'phocagallerym':
				$link = 'index.php?option=com_phocagallery&view=phocagallerym&layout=edit&hidemainmenu=1&tab='.(int)$tab.'&folder='.$parent;
			break;
